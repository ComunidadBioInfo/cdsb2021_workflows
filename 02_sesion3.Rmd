...
Usa uno de los proyectos que hayas generado en las sesiones anteriores, PERO, que no esté enlazado a GitHub. Ahora veremos como conectar un proyecti de R existente con GitHub. 
...
**Y LISTO!!** usa un simple `ctrl` + `c`, ó `mv` ó `click derecho` + `copiar` ó el método que prefieras oara mover o copiar archivos. Copia los archivos de tu antigüo proyecto al proyecto nuevo. 
